...
export default function EditProduct() {
    ...
    const checkAuthAndLoadProduct = async () => {
      try {
        ...
        if (productError) {
          ...
          toast.error(`Erro ao carregar produto: ${productError.message || 'Produto não encontrado'}`);
        ...
        // Adicionar a categoria atual se ainda não existir na lista
        ...
        console.error('Erro ao verificar autenticação ou carregar produto:', error);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Dados do produto a serem atualizados:', productData);
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            >
              {formSubmitting ? 'Salvando...' : 'Atualizar Produto'}
            </button>
          </div>
        </form>
      </div>
